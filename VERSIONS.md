...
|---|---:|---|---|
| Quick Start document | 1.4.0 | 2026-09-04 | `versions.json` → `document` |
| `apply-holmes-patch` scripts | 1.1.0 | commit `b244576e48206f3ade97cac5d0b8125033970c66` | `versions.json` → `patch_scripts` |
| `wiki-companion` plugin | 1.0.0 | 2026-09-04 | plugin `plugin.yaml` + `versions.json` |
| Hermes-Wiki schema | 1.0.0 | 2026-09-04 | `Hermes-Wiki/SCHEMA.md` + `versions.json` |
